...
DEBUG_METRIC_MAP = {
    ...
    'num_hard_pairs': 'debug/num_hard_pairs',
    'num_active_hbr_pairs': 'debug/num_active_hbr_pairs',
    'active_hbr_pair_ratio': 'debug/active_hbr_pair_ratio',
    'omega_mean': 'debug/omega_mean',
    'omega_std': 'debug/omega_std',
    'omega_max': 'debug/omega_max',
    'host_margin_hard_mean': 'debug/host_margin_hard_mean',
    'host_margin_hard_min': 'debug/host_margin_hard_min',
    'host_margin_hard_p10': 'debug/host_margin_hard_p10',
    'host_margin_hard_p50': 'debug/host_margin_hard_p50',
    'host_margin_hard_p90': 'debug/host_margin_hard_p90',
    'host_margin_easy_mean': 'debug/host_margin_easy_mean',
    'host_margin_global_hard_mean': 'debug/host_margin_global_hard_mean',
    'host_margin_local_hard_mean': 'debug/host_margin_local_hard_mean',
    'host_global_gate_mean': 'debug/host_global_gate_mean',
    'host_local_gate_mean': 'debug/host_local_gate_mean',
    'proto_pair_signal_mean': 'debug/proto_pair_signal_mean',
    'proto_pair_signal_std': 'debug/proto_pair_signal_std',
    'proto_pair_signal_max': 'debug/proto_pair_signal_max',
    'proto_pair_signal_hard_mean': 'debug/proto_pair_signal_hard_mean',
    'proto_pair_signal_easy_mean': 'debug/proto_pair_signal_easy_mean',
    'proto_gate_mean': 'debug/proto_gate_mean',
    'proto_gate_active_ratio': 'debug/proto_gate_active_ratio',
    'proto_signal_vs_host_margin_corr': 'debug/proto_signal_vs_host_margin_corr',
    'proto_signal_vs_global_margin_corr': 'debug/proto_signal_vs_global_margin_corr',
    'proto_signal_vs_local_margin_corr': 'debug/proto_signal_vs_local_margin_corr',
    'hbr_host_tail_size_mean': 'debug/hbr_host_tail_size_mean',
    'hbr_host_tail_margin_mean': 'debug/hbr_host_tail_margin_mean',
    'hbr_host_tail_margin_p10': 'debug/hbr_host_tail_margin_p10',
    'hbr_top_weight_overlap_with_bottom_host_margin': 'debug/hbr_top_weight_overlap_with_bottom_host_margin',
    'hbr_top_weight_in_host_tail_fraction': 'debug/hbr_top_weight_in_host_tail_fraction',
    'hbr_proto_signal_vs_host_margin_corr_in_tail': 'debug/hbr_proto_signal_vs_host_margin_corr_in_tail',
    'hbr_proto_signal_mean_in_tail': 'debug/hbr_proto_signal_mean_in_tail',
    'hbr_proto_signal_std_in_tail': 'debug/hbr_proto_signal_std_in_tail',
    'hbr_omega_mean_in_tail': 'debug/hbr_omega_mean_in_tail',
    'hbr_omega_max_in_tail': 'debug/hbr_omega_max_in_tail',
    'hbr_omega_entropy_in_tail': 'debug/hbr_omega_entropy_in_tail',
    'hbr_nonzero_omega_fraction': 'debug/hbr_nonzero_omega_fraction',
    'hbr_active_pairs_per_anchor': 'debug/hbr_active_pairs_per_anchor',
    'hbr_hardest_tail_margin_mean': 'debug/hbr_hardest_tail_margin_mean',
    'hbr_hardest_tail_margin_p10': 'debug/hbr_hardest_tail_margin_p10',
    'hbr_hbr_loss_active_mean': 'debug/hbr_hbr_loss_active_mean',
...
_VAL_DEBUG_NAMESPACE_MAP = {
    ...
    'eval_hard_pair_margin_eval_mean': 'val/hard_pair/margin_mean',
    'eval_hard_pair_margin_eval_p10': 'val/hard_pair/margin_p10',
    'eval_hard_pair_margin_eval_p50': 'val/hard_pair/margin_p50',
    'eval_hard_pair_margin_eval_p90': 'val/hard_pair/margin_p90',
    'eval_hard_pair_rank_error_rate': 'val/hard_pair/rank_error_rate',
    'eval_hard_pair_repair_rate': 'val/hard_pair/repair_rate',
    'eval_hard_pair_escape_rate_topk': 'val/hard_pair/escape_rate_topk',
    'eval_margin_global_hard_mean': 'val/hard_pair/global_margin_mean',
    'eval_margin_local_hard_mean': 'val/hard_pair/local_margin_mean',
    'hbr_host_tail_size_mean': 'val/hbr/host_tail_size_mean',
    'hbr_host_tail_margin_mean': 'val/hbr/host_tail_margin_mean',
    'hbr_host_tail_margin_p10': 'val/hbr/host_tail_margin_p10',
    'hbr_top_weight_overlap_with_bottom_host_margin': 'val/hbr/top_weight_overlap_with_bottom_host_margin',
    'hbr_top_weight_in_host_tail_fraction': 'val/hbr/top_weight_in_host_tail_fraction',
    'hbr_proto_signal_vs_host_margin_corr_in_tail': 'val/hbr/proto_signal_vs_host_margin_corr_in_tail',
    'hbr_proto_signal_mean_in_tail': 'val/hbr/proto_signal_mean_in_tail',
    'hbr_proto_signal_std_in_tail': 'val/hbr/proto_signal_std_in_tail',
    'hbr_omega_mean_in_tail': 'val/hbr/omega_mean_in_tail',
    'hbr_omega_max_in_tail': 'val/hbr/omega_max_in_tail',
    'hbr_omega_entropy_in_tail': 'val/hbr/omega_entropy_in_tail',
    'hbr_nonzero_omega_fraction': 'val/hbr/nonzero_omega_fraction',
    'hbr_active_pairs_per_anchor': 'val/hbr/active_pairs_per_anchor',
...
def map_train_diagnostic_key(raw_key: str) -> str:
    ...
    if raw_key in {
        'num_hard_pairs',
        'num_active_hbr_pairs',
        'active_hbr_pair_ratio',
        'omega_mean',
        'omega_std',
        'omega_max',
        'host_margin_hard_mean',
        'host_margin_hard_min',
        'host_margin_hard_p10',
        'host_margin_hard_p50',
        'host_margin_hard_p90',
        'host_margin_easy_mean',
        'host_margin_global_hard_mean',
        'host_margin_local_hard_mean',
        'host_global_gate_mean',
        'host_local_gate_mean',
        'proto_pair_signal_mean',
        'proto_pair_signal_std',
        'proto_pair_signal_max',
        'proto_pair_signal_hard_mean',
        'proto_pair_signal_easy_mean',
        'proto_gate_mean',
        'proto_gate_active_ratio',
        'proto_signal_vs_host_margin_corr',
        'proto_signal_vs_global_margin_corr',
        'proto_signal_vs_local_margin_corr',
        'hbr_host_tail_size_mean',
        'hbr_host_tail_margin_mean',
        'hbr_host_tail_margin_p10',
        'hbr_top_weight_overlap_with_bottom_host_margin',
        'hbr_top_weight_in_host_tail_fraction',
        'hbr_proto_signal_vs_host_margin_corr_in_tail',
        'hbr_proto_signal_mean_in_tail',
        'hbr_proto_signal_std_in_tail',
        'hbr_omega_mean_in_tail',
        'hbr_omega_max_in_tail',
        'hbr_omega_entropy_in_tail',
        'hbr_nonzero_omega_fraction',
        'hbr_active_pairs_per_anchor',
