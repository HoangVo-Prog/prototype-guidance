...
PRIMARY_CONFIG_KEY_MAP: Dict[Tuple[str, ...], str] = {
    ...
    ('loss', 'use_loss_ret_exact_image'): 'use_loss_ret_exact_image',
    ('loss', 'use_loss_ret_exact_text'): 'use_loss_ret_exact_text',
    ('loss', 'lambda_ret_exact'): 'lambda_ret_exact',
    ('loss', 'lambda_ret_exact_image'): 'lambda_ret_exact_image',
    ('loss', 'lambda_ret_exact_text'): 'lambda_ret_exact_text',
...
READ_ALIAS_CONFIG_KEY_MAP: Dict[Tuple[str, ...], str] = {
    ...
    ('training', 'use_loss_ret_exact_image'): 'use_loss_ret_exact_image',
    ('training', 'use_loss_ret_exact_text'): 'use_loss_ret_exact_text',
    ('training', 'lambda_ret_exact'): 'lambda_ret_exact',
    ('training', 'lambda_ret_exact_image'): 'lambda_ret_exact_image',
    ('training', 'lambda_ret_exact_text'): 'lambda_ret_exact_text',
