...
TRAIN_LOSS_KEYS = (
    ...
    'loss_proxy_weighted',
    'loss_ret_exact_image_weighted',
    'loss_ret_exact_text_weighted',
...
DEBUG_METRIC_MAP = {
    ...
    'ret_exact_temperature': 'debug/ret_exact_temperature',
    ...
    'exact_pairwise_logit_mean': 'debug/exact_pairwise_logit_mean',
    'exact_pairwise_logit_std': 'debug/exact_pairwise_logit_std',
    'exact_pairwise_logit_scale_or_norm': 'debug/exact_pairwise_logit_scale_or_norm',
    ...
    'exact_branch_grad_norm': 'debug/exact_branch_grad_norm',
